...
/* ===== HR/owner admin-record modal =====
   "ลงเวลาให้พนักงาน" — direct write. Pick an employee + date + at
   least one of check-in / check-out, optional note. Submits to
   POST /attendance/admin-record which upserts attendance_logs and
   notifies the employee. */
function AdminRecordModal({
