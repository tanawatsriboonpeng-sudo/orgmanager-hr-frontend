...
export interface PayrollRecord {
  // id is null for "slipless" rows — employees who match the active
  // roster for the selected month but don't have a payroll_records row
  // yet (e.g. hired after the last bulk-generate). All money/status
  // fields will be null on those rows; the table renders a "ยังไม่มี
  // สลิป" badge and a one-click create button.
  id: string | null
  employee_id: string
  month: number | null
  year: number | null
